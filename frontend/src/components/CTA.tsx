    ...
    <section className="py-24 bg-[--black] text-[--white] text-center">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 bg-[--mint] hover:bg-[--white] text-[--black] px-8 py-4 rounded-lg text-base font-medium transition-colors"
        >
