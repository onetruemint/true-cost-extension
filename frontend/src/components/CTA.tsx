export default function CTA() {
  return (
    <section className="py-24 bg-dark text-offwhite text-center">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 bg-mint hover:bg-offwhite text-dark px-8 py-4 rounded-lg text-base font-medium transition-colors"
        >
