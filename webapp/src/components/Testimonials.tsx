    ...
    <section className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            <div key={t.author} className="bg-gray-50 p-8 rounded-lg">
              <div className="text-yellow-400 text-lg mb-4">★★★★★</div>
              <p className="text-gray-900 leading-relaxed mb-4">&quot;{t.quote}&quot;</p>
              <div className="text-sm font-medium text-gray-600">- {t.author}</div>
            </div>
          ))}
        </div>
      </div>
